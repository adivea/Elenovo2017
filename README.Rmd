...
```
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-brightgreen.svg)](https://github.com/adivea/researchcompendium/commits/master) 
...
[![Travis-CI Build Status](https://travis-ci.org/adivea/researchcompendium.png?branch=master)](https://travis-ci.org/benmarwick/researchcompendium) 
[![Circle CI](https://circleci.com/gh/adivea/researchcompendium.svg?style=shield&circle-token=:circle-token)](https://circleci.com/gh/benmarwick/researchcompendium)
[![codecov.io](https://codecov.io/github/adivea/researchcompendium/coverage.svg?branch=master)](https://codecov.io/github/adivea/researchcompendium?branch=master) [![ORCiD](https://img.shields.io/badge/ORCiD-0000--0002--4541--3963-green.svg)](https://orcid.org/0000-0002-4541-3963) 
...
Adela Sobotkova (adela@fedarch.org)
